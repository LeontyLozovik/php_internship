...
(function () {
    ...
    var compileSchema = function (type) {
      ...
      phrasingContent = 'a abbr b bdo br button cite code del dfn em embed i iframe images input ins kbd ' + 'label map noscript object q s samp script select small span strong sub sup ' + 'textarea u var #text #comment';
      if (type !== 'html4') {
      ...
      if (type !== 'html4') {
        ...
        addAttrs('a', 'download');
        addAttrs('link script images', 'crossorigin');
    ...
    function Schema(settings) {
      ...
      shortEndedElementsMap = createLookupTable('short_ended_elements', 'area base basefont br col frame hr images input isindex link ' + 'meta param embed source wbr track');
    ...
    var isAtomicInline = NodeType.matchNodeNames('images input textarea hr iframe video audio object');
    ...
    var ControlSelection = function (selection, editor) {
      ...
      var getResizeTarget = function (elm) {
        return editor.dom.is(elm, 'figure.image') ? elm.querySelector('images') : elm;
      };
      var isResizable = function (elm) {
        ...
        if (typeof selector !== 'string') {
          selector = 'table,images,figure.image,div';
        }
      ...
      var updateResizeRect = function (e) {
        ...
        each(dom.select('images[data-mce-selected],hr[data-mce-selected]'), function (img) {
          img.removeAttribute('data-mce-selected');
        });
        controlElm = e.type === 'mousedown' ? e.target : selection.getNode();
        controlElm = dom.$(controlElm).closest('table,images,figure.image,hr')[0];
    ...
    function Quirks (editor) {
      ...
      var showBrokenImageIcon = function () {
        editor.contentStyles.push('images:-moz-broken {' + '-moz-force-broken-image-icon:1;' + 'min-width:24px;' + 'min-height:24px' + '}');
      };
    ...
    EditorManager = {
      ...
      init: function (settings) {
        ...
        invalidInlineTargets = Tools.makeMap('area base basefont br col frame hr images input isindex link meta param embed source wbr track ' + 'colgroup option tbody tfoot thead tr script noscript style textarea video audio iframe object menu', ' ');
